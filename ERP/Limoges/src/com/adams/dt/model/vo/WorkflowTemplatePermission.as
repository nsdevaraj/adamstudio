package com.adams.dt.model.vo
{
	...
	public final class WorkflowTemplatePermission
	{
		...
		public static var BACKTASK : int;
		...
		public static var CPVALIDATOR:int;
		public static var CPPVALIDATOR:int;	
		public static var AGENCEVALIDATOR:int;
		public static var COMVALIDATOR:int; 
		...
		public static function set workFlowTempStatusColl(arrc:ArrayCollection):void{
			...
			for each(var status:Status in _workFlowTempStatusColl){
				switch(status.statusLabel){
					...
					break;
					case 'CPVALIDATOR':
					CPVALIDATOR = status.statusId;
					break;
					case 'CPPVALIDATOR':
					CPPVALIDATOR = status.statusId;
					break;
					case 'COMVALIDATOR':
					COMVALIDATOR = status.statusId;
					break;
					case 'AGENCEVALIDATOR':
					AGENCEVALIDATOR = status.statusId;
					break;
					default :
					break;
				}
