...
package com.adams.dt.model.processor
{
	...
	public class DefaultTemplateValueProcessor extends AbstractProcessor
	{   
		public function DefaultTemplateValueProcessor()
		{
			super();
		}
		//@TODO
		...
		{
			if(!vo.processed){
				var defaulttemplatevaluevo:DefaultTemplateValue = vo as DefaultTemplateValue;
				super.processVO(vo);
			}
		}
	}
