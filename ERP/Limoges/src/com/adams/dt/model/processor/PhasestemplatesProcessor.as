...
package com.adams.dt.model.processor
{
	...
	public class PhasestemplatesProcessor extends AbstractProcessor
	{   
		public function PhasestemplatesProcessor()
		{
			super();
		}
		//@TODO
		...
		{
			if(!vo.processed){
				var phasestemplatesvo:Phasestemplates = vo as Phasestemplates;
				super.processVO(vo);
			}
		}
	}
