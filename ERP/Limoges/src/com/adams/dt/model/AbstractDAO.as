...
package com.adams.dt.model
{
	...
	import com.adams.dt.util.NativeMessenger;
	...
	{   
		...
		public function invokeAction( obj:SignalVO ):void {
			if( obj.destination == this.destination &&  BootStrapCommand.isDebugMode ) {
				switch( obj.action ) {
					case Action.CREATE:
