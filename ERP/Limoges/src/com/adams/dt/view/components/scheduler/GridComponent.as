	...
	public class GridComponent extends UIComponent
	{
		...
		override protected function updateDisplayList( unscaledWidth:Number, unscaledHeight:Number ):void {
			...
			if( contentWidth != previousContentWidth ) {
				...
				if( borderBox ) {
					...
					borderBox.graphics.lineStyle( 2, lineColor, 1 );
				...
				if( horizontalLine ) {
					...
					horizontalLine.graphics.lineStyle( 1, lineColor, 1 );
		...
		protected function findLimits():void {
			...
			for each( var item:Object in dataProvider ) {
				for each( var innerItem:Object in item.collection ) {
