...
{
	import com.adams.dt.business.datafilter.data.IDataFilter;
	...
	*/	
	public final class ControlBase extends EventDispatcher implements  IDataFilter
	{
		...
		*/
		public function set control( c : Object ) : void
		{
			...
			if ( _control as Array )
			{
				...
				{
					cn.addEventListener(Event.CHANGE , onChange , false , 0 , true);
				}
			}
		}
