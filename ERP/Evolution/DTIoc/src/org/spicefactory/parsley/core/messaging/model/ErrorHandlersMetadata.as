...
public class ErrorHandlersMetadata extends ErrorHandlers {
	...
	[MessageError(type="org.spicefactory.parsley.core.messaging.TestEvent")]
	...
	[MessageError(type="org.spicefactory.parsley.core.messaging.TestEvent", selector="test1")]
	public override function event1 (processor:MessageProcessor, error:ContextError) : void {
		super.event1(processor, error);
	}
	
	[MessageError(type="org.spicefactory.parsley.core.messaging.TestEvent", selector="test2")]
