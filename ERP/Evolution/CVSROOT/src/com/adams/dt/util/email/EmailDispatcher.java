...
public class EmailDispatcher {
    ...
    public boolean dispatch(com.adams.dt.util.email.Message message) {
    	Message msg = null;
	...
	private Message buildMessage(Session session, com.adams.dt.util.email.Message message) throws MessagingException, AddressException {
