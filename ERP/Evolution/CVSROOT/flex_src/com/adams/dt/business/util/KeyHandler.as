package com.adams.dt.business.util
{
	...
	public class KeyHandler
	{
		...
		{
			_autoTarget.addEventListener(Event.ADDED_TO_STAGE,onAutoOnStage,false,0,true);
			_autoTarget.addEventListener(Event.REMOVED_FROM_STAGE,onAutoOffStage,false,0,true);
		}
