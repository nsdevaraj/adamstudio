package com.adams.dt.model.vo.PDFTool
{
	...
	[Bindable]
	public final class PDFDetailVO implements ValueObject
	{
		...
		public var localeBool : Boolean = false;
		...
		// Notes modifications History ArrayCollection
		
		public var notesModificationHistoryAC:ArrayCollection = new ArrayCollection();
		
		public function update(pdffile1 : Tasks , pdffile2 : Tasks , profile : String) : void
		{
			
			detailLoadedStatus = PDFDetailVO.DETAIL_LOADING_STATUS_PENDING;
			pdfFileURL2 = pdffile2.taskFilesPath;
			if(pdffile1!=null)pdfFileURL1 = pdffile1.taskFilesPath;
			if(pdfFileURL1)
			{
			...
			if(pdffile1.fileObj!=null){
				if(pdffile1.fileObj.fileId==pdffile2.fileObj.fileId){
					pdfFileURL1 = '';
					PDFToolMode = PDFDetailVO.READER_MODE;	
				}
			} 
