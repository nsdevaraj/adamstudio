package com.adams.dt.event
{
	...
	public final class StatusEvent extends UMEvent
	{
		...
		public function StatusEvent (pType : String , handlers:IResponder=null,bubbles:Boolean=true,cancelable:Boolean=false,pStatus : Status = null )
		{
			status = pStatus;
