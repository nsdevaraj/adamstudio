			 ...
			 switch( event.type ) { 
			 	...
			 	case DefaultTemplateEvent.GET_COMMON_DEFAULT_TEMPLATE:
			    	...
			    	model.totalCompaniesColl.refresh();
			 	    ...
			 	    model.totalCompaniesColl.refresh();
			 	break;			 	
			 	case DefaultTemplateEvent.EVENT_ORACLE_CREATE_DEFAULT_TEMPLATE:
			 		this.delegate = DelegateLocator.getInstance().pagingDelegate;
		       		this.delegate.responder = new Callbacks(oracleCreateNewDefaultTempResult,fault);	
		       		//this.delegate.oracleCreateDefaultTemp(_defaultTemplateEvent.defaultTemplates,_defaultTemplateEvent.oracle_default_TemplateValue,_defaultTemplateEvent.oracle_properties_PresetFK,_defaultTemplateEvent.oracle_default_TemplateFK);       		
		       		this.delegate.oracleCreateDefaultTemp(_defaultTemplateEvent.defaultTemplates,_defaultTemplateEvent.oracle_default_TemplateValue,_defaultTemplateEvent.oracle_properties_PresetFK);
			 	break;
			 }
		}
		private function oracleCreateNewDefaultTempResult( rpcEvent:Object ):void {
