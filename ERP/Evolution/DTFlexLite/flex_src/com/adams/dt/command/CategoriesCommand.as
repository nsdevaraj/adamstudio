	...
	public final class CategoriesCommand extends AbstractCommand 
	{
		...
		{	
			...
			switch(event.type){
				...
				case CategoriesEvent.EVENT_CHECK_CATEGORIES:
					...
					trace("EVENT_CHECK_CATEGORIES :"+categories1.categoryFK.categoryId+"***"+categories1.categoryName+" --- "+categories2.categoryId+"***"+categories2.categoryName);
		...
		public function checkCategoriesTwoResult( rpcEvent : Object ) : void {
			...
			if(arrc.length>0){
				...
				trace("createCategoryOneResult categoryId1 :"+model.categories2.categoryId+" --- categoryName :"+model.categories2.categoryName);
		  		trace("createCategoryOneResult categoryId2 :"+model.categories2.categoryFK.categoryId+" --- categoryName :"+model.categories2.categoryFK.categoryName);
		  		trace("createCategoryOneResult categoryId3 :"+model.categories2.categoryFK.categoryFK.categoryId+" --- categoryName :"+model.categories2.categoryFK.categoryFK.categoryName);
		...
		public function getCategroies(arrc:ArrayCollection):Categories{
			for each(var item:Categories in arrc){
				trace("getCategroies calling :"+item.categoryFK.categoryId+" ,domain : "+model.domain.categoryId);					
				if(item.categoryFK.categoryId == model.domain.categoryId){
					trace("getCategroies calling inner:"+model.domain.categoryId);					
					return item;
				}
			}
			return null;
		...
		public function createCategoryTwoResult( rpcEvent : Object ) : void {
			...
			model.newProject.categories = model.categories2;
			trace("createCategoryTwoResult categoryId1 :"+model.newProject.categories.categoryId+" --- categoryName :"+model.newProject.categories.categoryName);
	  		trace("createCategoryTwoResult categoryId2 :"+model.newProject.categories.categoryFK.categoryId+" --- categoryName :"+model.newProject.categories.categoryFK.categoryName);
	  		trace("createCategoryTwoResult categoryId3 :"+model.newProject.categories.categoryFK.categoryFK.categoryId+" --- categoryName :"+model.newProject.categories.categoryFK.categoryFK.categoryName);
