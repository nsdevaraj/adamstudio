package com.adams.dt.event
{
	...
	public final class GroupsEvent extends UMEvent
	{
		...
		public function GroupsEvent (pType : String , handlers:IResponder=null,bubbles:Boolean=true,cancelable:Boolean=false, pGroups : Groups = null )
		{
			groups = pGroups;
			super(pType,handlers,true,false,groups);
		}
