package com.adams.dt.event
{
	...
	public final class TeamlineEvent extends UMEvent
	{
		...
		public static const EVENT_PUSH_NEWPROJECT: String = 'getPushNewProjectTeamline';
		...
		public static const EVENT_ORACLE_UPDATE_TEAMLINE : String = 'oracleupdateteamline';
		public static const EVENT_ORACLE_REFPROJECT_TEAMLINE : String = 'oracleRefupdateteamline';		
		...
		public var oracleprojectId:String = ''; 
		public var oracleprofileId:String = ''; 
		public var oraclepersonId:String = '';
		
		public var oraclepropertiesprojectId:String = '';
  		public var oraclepropertiespresetId:String = '';
  		public var oraclepropertiesfieldvalue:String = '';
  		
  		public var refProjectId:int;
		public var currentTaskId:int;
		public var refTypeName:String = '';
		public var refCategoryName:String = '';
		public var txtInputImpLength:int;
