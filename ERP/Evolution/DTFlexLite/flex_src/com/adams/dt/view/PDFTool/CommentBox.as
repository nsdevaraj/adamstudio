package com.adams.dt.view.PDFTool
{
	...
	public class CommentBox extends Canvas
	{
		...
		public var _resizeStatus:Boolean = false;
		[Bindable]
		public function set resizeStatus (value:Boolean):void
		{
			_resizeStatus = value;
		}

		public function get resizeStatus ():Boolean
		{
        ...
        public function changeSize():void
        {
        	...
        	miniMaxBtn.selected = resizeStatus;
        }
