package com.adams.dt.event
{
	...
	public final class DefaultTemplateEvent extends UMEvent
	{
		...
		public static const EVENT_ORACLE_CREATE_DEFAULT_TEMPLATE : String = 'oracleCreateDefaultTemplate';
		
		
		public var defaultTemplates:DefaultTemplate;
		public var companyId:int;
		
		//public var oracle_default_TemplateFK:String = ''; 
		public var oracle_properties_PresetFK:String = ''; 
		public var oracle_default_TemplateValue:String = ''; 		
