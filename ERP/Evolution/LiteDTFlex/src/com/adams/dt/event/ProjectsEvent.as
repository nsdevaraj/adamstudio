package com.adams.dt.event
{
	...
	public final class ProjectsEvent extends UMEvent
	{
		...
		public static const EVENT_UPDATE_PROJECT_PROPPJS : String = 'updateProjectPropPjs';
		...
		public static const EVENT_ORACLE_CLOSEPROJECT : String = 'closeOracleProject';		
		...
		public var endTaskCode : String = '';
		
		public var prop_fieldvalue : String = ' ';
		public var prop_presetId : String = ' ';
		public var projectclosingMode : String = ' ';
		public var projectCreatePersonId : int = 0;
