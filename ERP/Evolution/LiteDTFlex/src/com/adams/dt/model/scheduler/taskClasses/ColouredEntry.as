package com.adams.dt.model.scheduler.taskClasses
{
	...
	public class ColouredEntry implements IEntry
	{
		...
		private var _isCurrentTask:Boolean;
		...
		public function get isCurrentTask() : Boolean
		{
			return _isCurrentTask;
		}

		public function set isCurrentTask( value : Boolean ) : void
		{
