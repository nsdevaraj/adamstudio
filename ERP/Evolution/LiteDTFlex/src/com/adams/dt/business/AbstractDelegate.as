package com.adams.dt.business
{
	...
	public class AbstractDelegate extends Delegate
	{
		...
		public function createOracleNewProject(projectprefix : String,projectName : String,projectCommentName : String,categoryId : int,personId : int,rootFolder : String,
												categorydomain : IValueObject,category1 : IValueObject,category2 : IValueObject,workflowId : int,codeEAN : String,codeGEST : String,codeIMPRE : String,codeIMPID:int ,
		...
		public function createProjectProperties(projectID:String ,propertiesPresetID:String ,propValues:String) : void
		{
			invoke("createProjectProperties",projectID,propertiesPresetID,propValues);
		}
		public function createNavigationTasks(currenttaskId:int,workflowId:int,workflownexttempId:int,projId:int,personId:int,wftcode:String,tasksComments:String) : void
		{
			invoke("createNavigationTasks",currenttaskId,workflowId,workflownexttempId,projId,personId,wftcode,tasksComments);
		}
		public function oracleUpdateTeamline(projectId:String ,profileId:String ,personId:String,propprojectID:String, propertiesPresetID:String, propValues:String) : void
		{
			invoke("oracleUpdateTeamline",projectId,profileId,personId,propprojectID,propertiesPresetID,propValues);
		}
		public function oracleCreateDefaultTemp(defTempObj:DefaultTemplate, default_template_value:String, property_preset_fk:String) : void
		{
			invoke("oracleCreateDefaultTemp",defTempObj,default_template_value,property_preset_fk);
		}
		public function bulkDeleteId(deftempId : int) : void
		{
			invoke("bulkDeleteId",deftempId);
		}
		public function closeProjects(p_projectId:int, p_previousTask:int, p_workflowfk:int, p_tasksComment:String, p_propPresetFkArray:String, p_fieldValueArray:String, p_closingMode : String, p_personFk:int) : void
		{
		...
		public function projectStatusChangeTask(projectId :int , workflowFk :int , projectStatus :int,taskMessage:String,personFk :int ): void
		{
			invoke( "projectStatusChangeTask",projectId,workflowFk,projectStatus,taskMessage,personFk );
		}
		public function createReferenceFiles(ref_projectId :int, current_projectId :int, current_taskId :int, refTypeName:String, refCategoryName:String, 
