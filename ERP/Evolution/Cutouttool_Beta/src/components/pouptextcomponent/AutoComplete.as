...
package components.pouptextcomponent
{
import components.textInput.PTTextInputWmode;
...
public class AutoComplete extends ComboBox 
{
	 ...
	 *  @private
	 */
	private var frTextInput:PTTextInputWmode;
	/**
	 *  @private
	 */
	 ...
	 * data Provider
	 */
	 private var dataValue:ArrayCollection = new ArrayCollection([{label:"00:00"},{label:"00:30"},
																  {label:"01:00"},{label:"01:30"},
																  {label:"02:00"},{label:"02:30"},
																  {label:"03:00"},{label:"03:30"},
																  {label:"04:00"},{label:"04:30"},
																  {label:"05:00"},{label:"05:30"},
																  {label:"06:00"},{label:"06:30"},
																  {label:"07:00"},{label:"07:30"},
																  {label:"08:00"},{label:"08:30"},
																  {label:"09:00"},{label:"09:30"},
																  {label:"10:00"},{label:"10:30"},
																  {label:"11:00"},{label:"11:30"},
																  {label:"12:00"},{label:"12:30"},
																  {label:"13:00"},{label:"13:30"},
																  {label:"14:00"},{label:"14:30"},
																  {label:"15:00"},{label:"15:30"},
																  {label:"16:00"},{label:"16:30"},
																  {label:"17:00"},{label:"17:30"},
																  {label:"18:00"},{label:"18:30"},
																  {label:"19:00"},{label:"19:30"},
																  {label:"20:00"},{label:"20:30"},
																  {label:"21:00"},{label:"21:30"},
																  {label:"22:00"},{label:"22:30"},
																  {label:"23:00"},{label:"23:30"},
	 ...
	 * @public
	 */
	 public function callKeyDownHandler(event:KeyboardEvent):void{
	...
	public var closeDropDownCalled:Boolean;
	public function closeDropDown():void{
		 closeDropDownCalled = true;
	}
	public function checkDropDownStatus():void{
	...
	{
		var hoursVar:int = int(element.label.split(":")[0]);
		var typedTextVal:int = int(typedText.split(":")[0]);
		var flag:Boolean=false;
		if(int(typedTextVal) == hoursVar||int(typedTextVal)+1 == hoursVar) flag = true
		return flag;
	}
