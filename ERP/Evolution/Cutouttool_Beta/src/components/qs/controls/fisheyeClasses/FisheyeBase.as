package components.qs.controls.fisheyeClasses
{
	...
	import components.qs.controls.CachedLabel;
	import components.qs.controls.LayoutAnimator;
		...
		override protected function commitProperties():void
		{
			...
			if(renderersDirty)
			{
				...
				for(var j:int = 0;j<_items.length;j++)
				{
					...
					IDataRenderer(renderer).data = _items[j];
