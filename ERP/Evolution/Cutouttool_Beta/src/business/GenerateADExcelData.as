package business
{
	...
	public class GenerateADExcelData
	{
		public var totalValues:Object = new Object();
		...
		public function GenerateADExcelData()
		{
		}
	...
	* @returns: String
	*/
	private function convertDGToHTMLTable(dg:AdvancedDataGrid):String {
		//Set default values
			...
			for(var k:int=0; k < dg.columns.length; k++) {
				...
				//use instead of the dataField
					if(dg.columns[k].labelFunction != undefined) {
						...
						if(dg.columns[k].dataField=="Hours"||dg.columns[k].dataField=="mins"){
							str += "<td width=\""+Math.ceil(dg.columns[k].width)+"\" "+style+">"+dg.dataProvider.getItemAt(j)["Timing"][dg.columns[k].dataField]+"</td>";
						}else{
							str += "<td width=\""+Math.ceil(dg.columns[k].width)+"\" "+style+">"+dg.dataProvider.getItemAt(j)[dg.columns[k].dataField]+"</td>";
						}
						/*for(var lm:String in dg.dataProvider.getItemAt(j)){
							trace(lm+"---"+dg.dataProvider.getItemAt(j)[lm]);
						} */
					}
				}
			}
	...
	private function getTotal():String{
		var str:String = '';
		str = '<tr>';
		str += '<td width="123" bgcolor="#FFCC00" style="font-family:coFont;font-size:11pt;"></td>';
		str += '<td width="103" bgcolor="#FFCC00" style="font-family:coFont;font-size:15pt;font-weight:bold;color:red"><b>Total<b></td>';
		str += '<td width="123" bgcolor="#FFCC00" style="font-family:coFont;font-size:15pt;font-weight:bold;color:red"><b>'+totalValues.tasks+'</b></td>';
		str += '<td width="82" bgcolor="#FFCC00" style="font-family:coFont;font-size:15pt;font-weight:bold;color:red"><b>'+totalValues.images+'</b></td>';
		str += '<td width="62" bgcolor="#FFCC00" style="font-family:coFont;font-size:15pt;font-weight:bold;color:red"><b>'+totalValues.Hours+'</b></td>';
		str += '<td width="62" bgcolor="#FFCC00" style="font-family:coFont;font-size:15pt;font-weight:bold;color:red"><b>'+totalValues.mins+'</b></td>';
		str += '</tr>';
		return str;
	...
	*/
	public function loadDGInExcel(dg:AdvancedDataGrid):void {
