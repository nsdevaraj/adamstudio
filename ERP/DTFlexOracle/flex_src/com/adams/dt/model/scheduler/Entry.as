package com.adams.dt.model.scheduler
{
	public class Entry 
	{
		...
		private var _entryHeader:String;
		[Bindable]
		public function get entryHeader():String {
			return _entryHeader;
		}
		public function set entryHeader( value:String ):void {
			_entryHeader = value;
		} 
