package com.adams.dt.business
{
	...
	{			
		...
		//file
		 ...
		 function createFolderList(domain:IValueObject,categories1:IValueObject,categories2:IValueObject): void
		 function createProjectList(categoryName : String,categoryId : int,personId : int) : void
		 
		 function SelectALLCategories(workflowFK:int) : void	
		 function createBulkTasks(workflowFK:int, nextworkflowtempid:int, projId:int, perId:int,taskcode : String) : void
		 function createOracleNewProject(projectprefix : String,projectName : String,projectCommentName : String,categoryId : int,personId : int,rootFolder : String,categorydomain : IValueObject,category1 : IValueObject,category2 : IValueObject,workflowId : int,codeEAN : String,codeGEST : String,codeIMPRE : String) : void
	}
}
