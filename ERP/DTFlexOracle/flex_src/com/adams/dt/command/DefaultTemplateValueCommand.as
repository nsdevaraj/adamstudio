package com.adams.dt.command
{
	...
	public final class DefaultTemplateValueCommand extends AbstractCommand 
	{
		...
		override public function execute( event:CairngormEvent ):void {	
			...
			this.delegate.responder = new Callbacks( result, fault );
			 ...
			 switch( event.type ) { 
			 	...
			 	break;
			 	case DefaultTemplateValueEvent.GET_DELETE_TEMPLATE_VALUE:
			 		delegate.responder = new Callbacks( onDeleteValueUpdation, fault ); 
			 		delegate.findById( _defaultTemplateValueEvent.defaultTemplateValuesID );
			 	break;
		...
		private function onDeleteValueUpdation( rpcEvent:Object ):void {
			model.defaultTempValueColl = rpcEvent.result as ArrayCollection;
			model.defaultTempValueColl.refresh();
			super.result( rpcEvent );
		}
