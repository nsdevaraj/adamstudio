package com.adams.dt.control
{
	...
	public final class DTController extends FrontController
	{
		public function DTController()
		{
           ...
           //Sprints
           addCommand( SprintsEvent.EVENT_BULK_UPDATE_SPRINTS, SprintsCommand );
			...
			*/
			...
			addCommand(DefaultTemplateEvent.DELETE_DEFAULT_TEMPLATE , DefaultTemplateCommand);
			...
			addCommand( DefaultTemplateValueEvent.GET_DELETE_TEMPLATE_VALUE, DefaultTemplateValueCommand );
			...
			addCommand(CategoriesEvent.EVENT_ORACLE_NEWPROJECT , CategoriesCommand);
			
			addCommand(CategoriesEvent.EVENT_ORACLE_NEWPROJECTCALL , CategoriesCommand);			
			addCommand(TasksEvent.EVENT_ORACLE_NEWTASKCALL,TasksCommand);
