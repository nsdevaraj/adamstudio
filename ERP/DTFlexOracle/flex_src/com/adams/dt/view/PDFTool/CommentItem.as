package com.adams.dt.view.PDFTool
{
	...
	public class CommentItem extends Canvas
	{
		...
		override protected function createChildren():void
		{
			...
			{
				sprite.addEventListener(MouseEvent.MOUSE_DOWN, onMouseEvent,false,0,true);
				...
				resizeBtn.addEventListener(MouseEvent.MOUSE_DOWN, onResizeMouseEvent,false,0,true);
			}
        ...
        private function onResizeMouseEvent(event:MouseEvent):void
        {
        	if(event.type == MouseEvent.MOUSE_DOWN)
        	{
        		...
        		resizeBtn.addEventListener(MouseEvent.MOUSE_UP, onResizeMouseEvent,false,0,true);
        		resizeBtn.addEventListener(MouseEvent.MOUSE_MOVE, onResizeMouseEvent,false,0,true);
        	}
        ...
        private function onMouseEvent(event:MouseEvent):void
        {
        	if(model.pdfDetailVO.focusAction == SinglePageCanvas.NONE){
	        	if(event.type == MouseEvent.MOUSE_DOWN)
	        	{
					...
					addEventListener(MouseEvent.MOUSE_MOVE, onMouseEvent,false,0,true);
	        	}
	        	 if(event.type == MouseEvent.MOUSE_UP)
	        	{
