...
//                    }
        ...
        {     
			...
			EventsEntry(eventType, personId, taskId, projectId, errorDetails, workflowTemplateFk);
	...
	private void EventsEntry(Integer eventType, Integer personId, Integer taskId,
			Integer projectId, String error, Integer workflowTemplateFk) {
