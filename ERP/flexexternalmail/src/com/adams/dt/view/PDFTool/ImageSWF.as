package com.adams.dt.view.PDFTool
{
	...
	public class ImageSWF extends Canvas
	{
		...
		public function ImageSWF()
		{
			...
			loader.contentLoaderInfo.addEventListener(Event.COMPLETE,loaderInfoCompleteEvent);
		...
		private var _imgSourceBitmapData:ByteArray;
		public function set imgSourceBitmapData (value:ByteArray):void
		{
			_imgSourceBitmapData = value;
			trace("imgSourceBitmapDataimgSourceBitmapDataimgSourceBitmapDataimgSourceBitmapData :"+value);
			//swfloader.source = value as Bitmap; 
			loader.loadBytes(value);
		}
		public function get imgSourceBitmapData ():ByteArray
		{
			return _imgSourceBitmapData;
		}
