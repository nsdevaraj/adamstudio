	...
	public class DrawingSprite extends UIComponent
	{
		...
		override protected function createChildren():void
		{
			...
			if(pdf == SinglePageCanvas.PDF2){
				this.addEventListener(MouseEvent.CLICK, onMouseAction);
				this.addEventListener(MouseEvent.MOUSE_OVER, onMouseAction);
				this.addEventListener(MouseEvent.MOUSE_OUT, onMouseAction);
			}
