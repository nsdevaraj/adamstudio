...
public class Notes implements Serializable {
	...
	public void setCommentDescription(byte[] commentDescription) {
		...
		System.out.println("commentDescription :"+commentDescription);
		try {
	...
	public void setFilefk(int filefk) {
		System.out.println("filefk :"+filefk);
		this.filefk = filefk;
	}
		...
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		  try {
			  if(commentDescriptionBlob!=null) {
				  ...
				  this.commentDescription = new String("").getBytes();
			  }
			  System.out.println("setCommentDescriptionBlob :"+commentDescriptionBlob);
			  System.out.println("setCommentDescriptionBlob commentDescription:"+commentDescription);
