package com.adams.pdf.dao.hibernate;
...
import com.adams.pdf.pojo.Persons;
import com.adams.pdf.util.MailUtil;
...
public class DTPageDAO extends HibernateDaoSupport {
	...
	public List<?> getPersonListResult() throws Exception {
		List list = null;
		HibernateTemplate template = null;
	    try{
	    	System.out.println("getPersonListResult: **************calling ");
	  
	    	template = getHibernateTemplate();
	    	List<Persons> personList = (template.find("from Persons x"));
	    	list = new ArrayList();	
	    	list.add( personList );	   
	    	
	    	System.out.println("findAll personList:"+personList.size());
	    }catch(Exception e) {
	    	e.printStackTrace();
	    }
	    finally {  
	    		try {  
		           ...
		           System.out.println(e.getClass().getName() +  " getPersonListResult: " + e.toString());  
		        }  
    	}	    
	    return list;
	}
