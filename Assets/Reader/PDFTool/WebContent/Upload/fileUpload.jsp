 ...
 String destFolder = appPath + "Files/";
 out.println("<br>destFolder : " + destFolder);
 //filename= destFolder + filename;
 //filename= destFolder + "kumar.pdf";
 String finalFile = destFolder + filename;
 out.println("<br>filename : " + finalFile);
