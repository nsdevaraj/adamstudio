...
package com.adams.pdf.model.vo
{
	...
	[RemoteClass(alias='com.adams.pdf.pojo.FileDetails')]
	public class FileDetails extends AbstractVO
	{
		...
		private var _fileSizing:String;
		public function set fileSizing (value:String):void
		{
			_fileSizing = value;
		}
		public function get fileSizing ():String
		{
			return _fileSizing;
		}
		
		private var _thumbnailPath:String;
		public function set thumbnailPath( value:String ):void {
