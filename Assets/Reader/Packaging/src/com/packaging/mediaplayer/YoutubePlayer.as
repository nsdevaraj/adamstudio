package com.packaging.mediaplayer
{
	import com.packaging.controls.VolumeBar;
	...
	import com.packaging.controls.ScrubBar;
	...
	public class YoutubePlayer extends SkinnableComponent
	{
		...
		{
			if(player.player)player.player.stopVideo();
			timer.stop();
			timer.reset();
			volumeBar.value = 0.5;
			scrubBar.value = 0;
