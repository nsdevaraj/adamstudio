 ...
 * 		  
 * 		<li> tween the <code>currentTime</code>, <code>totalTime</code>, or <code>currentProgress</code> property to fastforward/rewind the timeline. You could 
 ...
 **/
	public class TimelineMax extends TimelineLite implements IEventDispatcher {
		/** @private **/
		public static const version:Number = 0.941;
		...
		public function tweenTo(timeOrLabel:*, vars:Object=null):TweenLite {
			...
			varsCopy.currentTime = (typeof(timeOrLabel) == "string") ? getLabelTime(timeOrLabel) : Number(timeOrLabel);
			this.paused = true;
