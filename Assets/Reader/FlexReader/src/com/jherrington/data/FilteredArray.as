...
&lt;mx:DataGrid dataProvider="{outData}" /&gt;
	 ...
	 */
	public class FilteredArray extends EventDispatcher implements IList, IFilteredData
	{
		/**
		 ...
		 */
		public function removeItemAt(index:int):Object { return null; }
		
		/**
		 * Sets an item at a specific location. Ignored by this class.
		 */
		public function setItemAt(item:Object, index:int):Object { return null; }
