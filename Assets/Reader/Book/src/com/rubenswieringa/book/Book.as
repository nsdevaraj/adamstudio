package com.rubenswieringa.book {
	...
	import com.rubenswieringa.disortedImage.DistortImage;
	import com.rubenswieringa.geom.Geom;
	import com.rubenswieringa.managers.StateManager;
	import com.rubenswieringa.pageFlip.PageFlip;
	...
	public class Book extends PageManager {
		...
		public  var lastFlippedSide:uint;
		/**
	...
	// PAGEFLIP PROCESSING:
		...
		public function removePageListener( ) :void
		{
			if(stage)stage.removeEventListener(MouseEvent.MOUSE_UP, this.endPageFlip);
