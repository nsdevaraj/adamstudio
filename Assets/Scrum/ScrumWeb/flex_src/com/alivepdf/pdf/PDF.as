...
package com.alivepdf.pdf
{
	import com.alivepdf.annotations.Annotation;
	import com.alivepdf.annotations.MovieAnnotation;
	import com.alivepdf.annotations.TextAnnotation;
	import com.alivepdf.cells.CellVO;
	import com.alivepdf.colors.CMYKColor;
	import com.alivepdf.colors.GrayColor;
	import com.alivepdf.colors.IColor;
	import com.alivepdf.colors.RGBColor;
	import com.alivepdf.colors.SpotColor;
	...
	import com.alivepdf.display.PageMode;
	import com.alivepdf.drawing.DashedLine;
	import com.alivepdf.drawing.WindingRule;
	import com.alivepdf.encoding.Base64;
	import com.alivepdf.encoding.JPEGEncoder;
	import com.alivepdf.encoding.PNGEncoder;
	import com.alivepdf.encoding.TIFFEncoder;
	import com.alivepdf.events.CharacterEvent;
	import com.alivepdf.events.PageEvent;
	import com.alivepdf.events.ProcessingEvent;
	import com.alivepdf.fonts.CoreFont;
	import com.alivepdf.fonts.EmbeddedFont;
	import com.alivepdf.fonts.FontDescription;
	import com.alivepdf.fonts.FontFamily;
	import com.alivepdf.fonts.FontMetrics;
	import com.alivepdf.fonts.FontType;
	import com.alivepdf.fonts.IFont;
	import com.alivepdf.html.HTMLTag;
	import com.alivepdf.images.ColorSpace;
	import com.alivepdf.images.DoJPEGImage;
	import com.alivepdf.images.DoPNGImage;
	import com.alivepdf.images.DoTIFFImage;
	import com.alivepdf.images.GIFImage;
	import com.alivepdf.images.ImageFormat;
	import com.alivepdf.images.JPEGImage;
	import com.alivepdf.images.PDFImage;
	import com.alivepdf.images.PNGImage;
	import com.alivepdf.images.TIFFImage;
	import com.alivepdf.images.gif.player.GIFPlayer;
	import com.alivepdf.layout.Align;
	import com.alivepdf.layout.Layout;
	import com.alivepdf.layout.Mode;
	import com.alivepdf.layout.Position;
	import com.alivepdf.layout.Resize;
	import com.alivepdf.layout.Size;
	import com.alivepdf.layout.Unit;
	import com.alivepdf.links.HTTPLink;
	import com.alivepdf.links.ILink;
	import com.alivepdf.links.InternalLink;
	import com.alivepdf.links.Outline;
	import com.alivepdf.operators.Drawing;
	import com.alivepdf.pages.Page;
	import com.alivepdf.saving.Method;
	import com.alivepdf.tools.sprintf;
	import com.alivepdf.visibility.Visibility;
	 ...
	 *
	 * @eventType com.alivepdf.events.PageEvent.ADDED
	 *
	 * * @example
	 ...
	 * </div>
	 */
	[Event(name='added', type='com.alivepdf.events.PageEvent')]
	
	/**
	 * Dispatched when PDF has been generated and available. The save() method generate this event
	 *
	 * @eventType com.alivepdf.events.ProcessingEvent.COMPLETE
	 *
	 * * @example
	 * This example shows how to listen for such an event :
	 * <div class="listing">
	 ...
	 * </div>
	 */
	[Event(name='complete', type='com.alivepdf.events.ProcessingEvent')]
	
	/**
	 * Dispatched when the PDF page tree has been generated. The save() method generate this event
	 *
	 * @eventType com.alivepdf.events.ProcessingEvent.PAGE_TREE
	 *
	 * * @example
	 * This example shows how to listen for such an event :
	 * <div class="listing">
	 ...
	 * </div>
	 */
	[Event(name='pageTree', type='com.alivepdf.events.ProcessingEvent')]
	 ...
	 *
	 * @eventType com.alivepdf.events.ProcessingEvent.RESOURCES
	 *
	 * * @example
	 * This example shows how to listen for such an event :
	 * <div class="listing">
	 ...
	 * </div>
	 */
	[Event(name='resources', type='com.alivepdf.events.ProcessingEvent')]
	
	/**
	 * Dispatched when the PDF generation has been initiated. The save() method generate this event
	 *
	 * @eventType com.alivepdf.events.ProcessingEvent.STARTED
	 *
	 * * @example
	 * This example shows how to listen for such an event :
	 * <div class="listing">
	 ...
	 * </div>
	 */
	[Event(name='started', type='com.alivepdf.events.ProcessingEvent')]
	...
	public class PDF implements IEventDispatcher
	{
		...
		*/
		 ...
		 * </div>
		 */
		public var _imageData:DisplayObject;
		public var getDic:Dictionary
		public function addMultiCell ( width:Number, height:Number, text:String, border:*=0, align:String='J', filled:int=0):void
		{
			...
			if (getDic[text] !=undefined)
			{
				var displayObj:DisplayObject = getDic[text];
				if(displayObj != null)
				var xPos:Number=(currentX + (width/2));
				addImage(displayObj, null, xPos-13, currentY-9, 3, 3, 0, 1, true, ImageFormat.PNG, 100);
			}	
			else
			{
