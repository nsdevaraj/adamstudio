...
{
	import com.adams.dt.utils.FileNameSplitter;
	...
	public class FileDetails implements IValueObject
	{
		...
		{
			_fileName = value;
 			var object:Object = FileNameSplitter.splitFileName(_fileName);
			extension = object.extension//String(fileName.split(".")[1]).toLowerCase();
 		}
		...
		public function set categoryObject (value : Categories) : void
		{
			...
			_categoryFK = value.categoryId;
		}
		
		public function get categoryObject () : Categories
		{ 
			if(_categoryObject == null)
				_categoryObject = GetVOUtil.getVOObject(_categoryFK,GetVOUtil.categoryList,'categoryId',Categories) as Categories;
