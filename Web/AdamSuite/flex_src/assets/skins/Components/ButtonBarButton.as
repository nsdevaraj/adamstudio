...
package assets.skins.Components
{
	import assets.skins.TabBarButtonSkin;
	...
	public class ButtonBarButton extends ToggleButton implements IItemRenderer
	{
		...
		public function set data(value:Object):void
		{
			...
			TabBarButtonSkin(skin).imgUp = content.upSource;
			TabBarButtonSkin(skin).imgSelected = content.selectedSource
