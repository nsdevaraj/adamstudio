 ...
 */
	public class TweenMax extends TweenLite implements IEventDispatcher {
		/** @private **/
		public static const version:Number = 11.099991;
		...
		public function TweenMax(target:Object, duration:Number, vars:Object) {
			...
			if ("onCompleteListener" in this.vars || "onUpdateListener" in this.vars || "onStartListener" in this.vars || "onRepeatListener" in this.vars || "onReverseCompleteListener" in this.vars) {
				initDispatcher();
